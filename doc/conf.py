...
# -*- coding: utf-8 -*-
#
# vocaldetection documentation build configuration file, created by
...
htmlhelp_basename = 'vocaldetectiondoc'
...
latex_documents = [
  ('index', 'vocaldetection.tex', 'vocaldetection Documentation',
   'Ariel Rokem', 'manual'),
]
