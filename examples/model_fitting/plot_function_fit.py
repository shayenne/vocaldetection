...
# ------------
#
# First, we'll load some data into vocaldetection.
...
# ---------------
#
# With vocaldetection, models are created with the :ref:Model class.
